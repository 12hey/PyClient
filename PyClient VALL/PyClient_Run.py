...
def button1_clicked():
    os.system("start KillAura.exe")

def button2_clicked():
    os.system("start AimBot.exe")

def button3_clicked():
    os.system("start openproject.exe")

def button4_clicked():
    os.system("start Tp+.exe")

def keyclick():
    os.system("start key.exe")

def run():
    os.system("start PyClient_V4.exe")
window = tk.Tk()
window.title("PYClient_Run(Version Launcher)")
